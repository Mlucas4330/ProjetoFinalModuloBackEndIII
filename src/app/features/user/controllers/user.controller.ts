...
import { ListUsersUseCase } from '../usecases/list.user';
...
export class UserController {
    public async list(req: Request, res: Response) {
        try {
            const usecase = new ListUsersUseCase(new UserRepository(), new CacheRepository());
    ...
    public async login(req: Request, res: Response) {
        try {
            ...
            const usecase = new LoginUserUseCase(new UserRepository(), new CacheRepository());
    ...
    public async get(req: Request, res: Response) {
        try {
            ...
            const usecase = new GetUserUseCase(new UserRepository(), new CacheRepository());
    ...
    public async createUser(req: Request, res: Response) {
        try {
            ...
            const usecase = new CreateUserUseCase(new UserRepository(), new CacheRepository());
            const result = await usecase.execute({
                name,
                email,
                password
    ...
    public async update(req: Request, res: Response) {
        try {
            ...
            const usecase = new UpdateUserUseCase(new UserRepository(), new CacheRepository());
    ...
    public async delete(req: Request, res: Response) {
        try {
            ...
            const usecase = new DeleteUserUseCase(new UserRepository(), new CacheRepository());
